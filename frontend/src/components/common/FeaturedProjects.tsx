...
const featuredProjects: Project[] = [
  {
    ...
    description: 'A full-stack e-commerce platform built with React, Node.js, and MongoDB. Features include user authentication, payment processing, inventory management, and real-time order tracking.',
    shortDescription: 'Full-stack e-commerce platform with payment processing',
    ...
    challenges: 'Implementing secure payment processing and real-time inventory updates',
    solutions: 'Used Stripe for payments and Socket.io for real-time features',
    duration: '3 months',
    teamSize: 1,
    isPublic: true,
    views: 1250,
